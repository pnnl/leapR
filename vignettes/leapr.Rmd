...
results.frame.or = data.frame(pathway=pathways_of_interest,
                           ...
                           td.order=all_results[[9]][pathways_of_interest,"zscore"],
                           pd.order=all_results[[10]][pathways_of_interest,"zscore"],
                           fd.order=all_results[[11]][pathways_of_interest,"zscore"],
                           cd.order=all_results[[12]][pathways_of_interest,"zscore"],
