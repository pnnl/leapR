...
transdata.enrichment.svl = leapR(geneset=ncipid, 
                                enrichment_method='enrichment_comparison',
                                datamatrix=transdata, primary_columns=shortlist,
                                secondary_columns=longlist)

# enrichmetn in proteomics data
...
phosphodata.enrichment.svl = leapR(geneset=ncipid,
                                   enrichment_method='enrichment_comparison',
                                   datamatrix=phosphodata, primary_columns=shortlist,
                                   secondary_columns=longlist, id_column=1)

resultsmat = cbind(transdata.enrichment.svl[,"pvalue"], protdata.enrichment.svl[,"pvalue"], phosphodata.enrichment.svl[,"pvalue"])
rownames(resultsmat) = rownames(phosphodata.enrichment.svl)
colnames(resultsmat) = c("TXN", "PROT", "PHOSPHO")
